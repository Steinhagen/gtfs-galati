...
Separately: the routes still listed in the README FIXME (50, 55, 7, 44, 39/39B, 11-28) aren't built yet, so their stops aren't in stops.txt. OSM does have relations for several of them (11, 15, 20, 24, 26, 28, 39, 44, 7), so
shape data is available when you get to them. Routes 13, 23, 25, 30, 50, 55 either have no relation or an unnamed/stale one
